...
namespace OnlineShop.Services.Api.Middleware;
/// <summary>
...
internal class ExceptionHandlerMiddleware
{
    ...
    private static (HttpStatusCode httpStatusCode, IReadOnlyCollection<Error>) GetHttpStatusCodeAndErrors(Exception exception)
    {
        ...
        {
            FluentValidation.ValidationException validationException => (HttpStatusCode.BadRequest, ((ValidationException)validationException).Errors),
